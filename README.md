...
Chrome extension that polls [x.com/i/account_analytics](https://x.com/i/account_analytics) and puts two counters on the toolbar:
...
The badge is today's reply count. The icon and popup show replies **and** verified followers.
...
| Replies you posted | **Posts / Replies** chart (green Replies series). This is outbound. |
...
In the popup: reply goal, verified goal, poll interval (1–120 minutes). Stored locally only. Nothing is uploaded.
